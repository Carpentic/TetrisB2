...
namespace TetrisB2.Game.Tetrominos
{
    public class JTetromino : Tetromino
    {
        ...
        {
            m_blocks.Add(new DrawableBlock(height, width, 0, 0, "blue_block"));
            m_blocks.Add(new DrawableBlock(height, width, height, 0, "blue_block"));
            m_blocks.Add(new DrawableBlock(height, width, height, width, "blue_block"));
            m_blocks.Add(new DrawableBlock(height, width, height, 2 * width, "blue_block"));
        }
